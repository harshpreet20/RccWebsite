...
const SPONSOR_AGENTS = [
  {
    ...
    color: "#F59E0B",
    bgColor: "#FFFBEB",
    endpoint: "/api/studio/sponsor/agents/ideator",
  },
  {
    name: "Hook & Script",
    ...
    color: "#EC4899",
    bgColor: "#FDF2F8",
    endpoint: "/api/studio/sponsor/agents/hooks",
  },
  {
    name: "AI Reel Prompt",
    ...
    color: "#F97316",
    bgColor: "#FFF7ED",
    endpoint: "/api/studio/sponsor/agents/reel-prompt",
    configKey: "quality",
    configOptions: [
  ...
  },
  {
    ...
    color: "#8B5CF6",
    bgColor: "#F5F3FF",
    endpoint: "/api/studio/sponsor/agents/planner",
  },
  {
    name: "Analyst",
    ...
    color: "#10B981",
    bgColor: "#ECFDF5",
    endpoint: "/api/studio/sponsor/agents/analyst",
  },
  {
    name: "DM Manager",
    ...
    color: "#3B82F6",
    bgColor: "#EFF6FF",
    endpoint: "/api/studio/sponsor/agents/dm-manager",
  },
];
...
export default function SponsorPage() {
  ...
  async function scrapeSponsor() {
    ...
    setSponsor(null);
    try {
      const res = await fetch("/api/studio/sponsor/scrape", {
        method: "POST",
