...
export default function RCCShopSection() {
  ...
  return (
    <section id="shop" className="relative border-t border-[var(--color-border)] bg-[#0a0a0f] py-20">
      <div className="mx-auto max-w-7xl px-5">
          ...
          {(loaded ? products : Array.from({ length: 5 })).map((p, i) => {
            ...
            return (
              <a
                ...
                className="group flex flex-col overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[#111118] transition hover:border-[var(--color-gold)]/40"
              >
                <div className="relative aspect-square overflow-hidden bg-[#0d0d14]">
                  {loaded && product.image ? (
                    ...
                    <div
                      ...
                      style={{
                        background: loaded
                          ? `radial-gradient(120% 120% at 30% 20%, ${product.accent ?? '#1f8f88'}, #06090f)`
                          : '#111118',
                      }}
                    >
                  ...
                  {loaded && product.badge && (
                    <span className="absolute left-2 top-2 rounded bg-[var(--color-gold)] px-1.5 py-0.5 text-[9px] font-black uppercase tracking-wide text-black">
                      {product.badge}
                    </span>
                  )}
                </div>
        ...
        <div className="mt-8 text-center">
          <a
            href={STORE_ORIGIN}
            className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[var(--color-gold)] hover:underline"
          >
