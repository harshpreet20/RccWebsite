...
export default function Sidebar({ active }: { active: string }) {
  ...
  const sections: Section[] = [
    { title: "Content AI", tone: "gray", links: [
    ...
    { title: "Commerce", tone: "emerald", links: [
      { href: `${BASE}/orders`, label: "Orders" },
      { href: `${BASE}/products`, label: "Store" },
  ...
  const UserFooter = user && (
    <div className="flex flex-col gap-2.5">
      <Link
        href="/admin/events"
        className="px-1 text-[11px] font-semibold text-gray-400 hover:text-gray-600 transition"
      >
        &larr; Main site admin
      </Link>
